...
public class VkPipelineRenderingBuilder extends PNextChainable {
	...
	private List<VkFormat> colorAttachmentFormats;
	private VkFormat depthAttachmentFormat = VkFormat.UNDEFINED;
	private VkFormat stencilAttachmentFormat = VkFormat.UNDEFINED;
	...
	public List<VkFormat> getColorAttachmentFormats() {
		return colorAttachmentFormats;
	}

	public VkPipelineRenderingBuilder setColorAttachmentFormats(List<VkFormat> colorAttachmentFormats) {
		this.colorAttachmentFormats = colorAttachmentFormats;
		return this;
	}

	public VkFormat getDepthAttachmentFormat() {
		return depthAttachmentFormat;
	}

	public VkPipelineRenderingBuilder setDepthAttachmentFormat(VkFormat depthAttachmentFormat) {
		this.depthAttachmentFormat = depthAttachmentFormat;
		return this;
	}

	public VkFormat getStencilAttachmentFormat() {
		return stencilAttachmentFormat;
	}

	public VkPipelineRenderingBuilder setStencilAttachmentFormat(VkFormat stencilAttachmentFormat) {
