...
public record VkPhysicalDeviceSwapChainInfo(
	...
	public boolean supportsFormat(VkFormat format) {
		...
		public static SurfaceCapabilities getFrom(org.lwjgl.vulkan.VkPhysicalDevice physicalDevice, long surface) {
			try (MemoryStack stack = MemoryStack.stackPush()) {
				...
				return new SurfaceCapabilities(
						...
						VkSurfaceTransform.maskAsSet(surfaceCapabilities.supportedTransforms()),
						VkCompositeAlpha.maskAsSet(surfaceCapabilities.supportedCompositeAlpha()),
						VkImageUsage.maskAsSet(surfaceCapabilities.supportedUsageFlags())
				);
			}
		}
