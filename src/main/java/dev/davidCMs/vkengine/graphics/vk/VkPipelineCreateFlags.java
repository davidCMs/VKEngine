...
public enum VkPipelineCreateFlags {
	...
	public static long getMaskOf(VkPipelineCreateFlags... bits) {
	...
	public static long getMaskOf(Iterable<VkPipelineCreateFlags> bits) {
	    if (bits == null) return 0;
	...
	public static boolean doesMaskHave(long mask, VkPipelineCreateFlags bit) {
	    if (bit == null) return false;
	    return (mask & bit.bit) != 0;
	}

	public static Set<VkPipelineCreateFlags> maskAsSet(long mask) {
	    Set<VkPipelineCreateFlags> set = new HashSet<>();
	    for (VkPipelineCreateFlags bit : values()) {
	        if ((bit.bit & mask) != 0) set.add(bit);
	    }
	    return set;
	}

	public static VkPipelineCreateFlags valueOf(long bitVal) {
	    for (VkPipelineCreateFlags bit : values()) {
